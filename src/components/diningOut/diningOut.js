...
import { dining } from "../../data/diningOut.js";
...
const DiningOut = () => {
  return (
    <div>
      ...
      <div className='max-width'> <Filters filterList={ diningFilters } /> </div>
      <ExploreSection resList={diningList} collectionName="Dine-Out restaurants in Banglore" />
    </div>
  )
}
